...
5. Fold in the small code fixes: ~~duplicate listeners~~ (done 2026-07-08), ~~focus on view switch~~ (done 2026-07-08), ~~`nth-child` alternation~~ (done 2026-07-08), faint-text contrast.
